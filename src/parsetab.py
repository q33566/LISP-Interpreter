...
_lr_productions = [
  ...
  ('fun_ids -> ( ids )','fun_ids',3,'p_fun_ids','my_yacc.py',190),
  ('ids -> ID ids','ids',2,'p_ids','my_yacc.py',196),
  ('ids -> empty','ids',1,'p_ids','my_yacc.py',197),
  ('last_exp -> exp','last_exp',1,'p_last_exp','my_yacc.py',206),
  ('fun_call -> ( fun_exp params )','fun_call',4,'p_fun_call','my_yacc.py',212),
  ('fun_call -> ( fun_name params )','fun_call',4,'p_fun_call','my_yacc.py',213),
  ('params -> param params','params',2,'p_params','my_yacc.py',221),
  ('params -> empty','params',1,'p_params','my_yacc.py',222),
  ('param -> exp','param',1,'p_param','my_yacc.py',231),
  ('variable -> ID','variable',1,'p_variable','my_yacc.py',237),
  ('fun_name -> ID','fun_name',1,'p_fun_name','my_yacc.py',245),
  ('if_exp -> ( IF exp exp exp )','if_exp',6,'p_if_exp','my_yacc.py',252),
]
